...
class Hoadon extends Model
{
    ...
    function chitiethoadon($id){
        $query = "select ct.*, s.TenSP as Ten, hd.TrangThai as TrangThai from chitiethoadon as ct, sanpham as s, hoadon as hd where ct.MaSP = s.MaSP and hd.MaHD = ct.MaHD and ct.MaHD = $id ";
